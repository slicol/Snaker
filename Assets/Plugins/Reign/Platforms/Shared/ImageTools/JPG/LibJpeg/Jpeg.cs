...
namespace BitMiracle.LibJpeg
{
    ...
    class Jpeg
    {
		jpeg_compress_struct m_compressorObj;
        private jpeg_compress_struct m_compressor// = new jpeg_compress_struct(new jpeg_error_mgr());
		{
			get
			{
				if (m_compressorObj == null) m_compressorObj = new jpeg_compress_struct(new jpeg_error_mgr());
        ...
        private jpeg_decompress_struct m_decompressor// = new jpeg_decompress_struct(new jpeg_error_mgr());
		{
			get
			{
				if (m_decompressorObj == null) m_decompressorObj = new jpeg_decompress_struct(new jpeg_error_mgr());
